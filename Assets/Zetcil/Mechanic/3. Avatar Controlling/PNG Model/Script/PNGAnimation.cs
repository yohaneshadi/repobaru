...
namespace Zetcil
{
    ...
    public class PNGAnimation : MonoBehaviour
    {
        ...
        void Update()
        {
            if (_motor.motorState == PNGMovementController.MotorState.Jumping ||
                _isJumping &&
                    (_motor.motorState == PNGMovementController.MotorState.Falling ||
                                 _motor.motorState == PNGMovementController.MotorState.FallingFast))
            {
                _isJumping = true;
                _animator.Play("Jump");
            ...
            else
            {
                ...
                if (_motor.motorState == PNGMovementController.MotorState.Falling ||
                                 _motor.motorState == PNGMovementController.MotorState.FallingFast)
                {
                    _animator.Play("Fall");
                }
                else if (_motor.motorState == PNGMovementController.MotorState.WallSliding ||
                         _motor.motorState == PNGMovementController.MotorState.WallSticking)
                {
                    _animator.Play("Cling");
                }
                else if (_motor.motorState == PNGMovementController.MotorState.OnCorner)
                {
                    _animator.Play("On Corner");
                }
                else if (_motor.motorState == PNGMovementController.MotorState.Slipping)
                {
                    _animator.Play("Slip");
                }
                else if (_motor.motorState == PNGMovementController.MotorState.Dashing)
                {
                    _animator.Play("Dash");
                }
                else
            ...
            if (_motor.motorState == PNGMovementController.MotorState.Slipping ||
                _motor.motorState == PNGMovementController.MotorState.Dashing ||
                _motor.motorState == PNGMovementController.MotorState.Jumping)
            {
